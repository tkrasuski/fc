...
class InventoryPart(forms.Form):
    ...
    unit = forms.CharField(required=True, widget=forms.Select(choices=Units.objects.all().values_list('code','code'),attrs={'class':'form-control form-control-sm','placeholder':'Unit'}))
